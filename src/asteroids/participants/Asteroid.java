...
public class Asteroid extends Participant implements ShipDestroyer, AlienDestroyer
{
    ...
    public Asteroid (int variety, int size, double x, double y, int speed, Controller controller)
    {
        ...
        speed = controller.getAsteroidSpeed();
    }
...
//            if(controller.Level() > 1 && speed < SPEED_LIMIT)
//            {
//            	speed++;
//            }
            if (size >= 0)
            {
                ...
                controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(), 5, controller));
                controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(), 5, controller));
            }
            
            // Inform the controller
            //calculates score too!
